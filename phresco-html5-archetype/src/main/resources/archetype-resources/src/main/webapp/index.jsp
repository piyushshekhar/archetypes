...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript" src="lib/yui/build/yui/yui.js"></script>
		<script type="text/javascript" src="lib/yui/build/json-parse/json-parse-min.js"></script>
		<script type="text/javascript" src="lib/yui/build/io-base/io-base.js"></script>
		<script type="text/javascript" src="lib/yui/build/io-xdr/io-xdr-min.js"></script>
