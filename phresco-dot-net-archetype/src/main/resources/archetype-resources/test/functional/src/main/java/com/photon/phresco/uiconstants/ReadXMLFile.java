...
public class ReadXMLFile {
	...
	private static final String photonblogdata = "src/main/resources/PhotonData.xml";
	...
	public void loadphpData() throws ScreenException {
    	loadPhrescoConstansts(photonblogdata);
	}
