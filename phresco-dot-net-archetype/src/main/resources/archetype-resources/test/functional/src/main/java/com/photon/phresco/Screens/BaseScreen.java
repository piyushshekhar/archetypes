...
public class BaseScreen {
	...
	private PhotonData phpConstants;
	...
	public BaseScreen(String selectedBrowser, String applicationURL,
			String applicationContext, PhotonData phpConstants,
			UIConstants uiConstants, UserInfoConstants userInfo)
			throws ScreenException, IOException {
	...
	public void helloWorld(String methodName) throws Exception {
		...
		// Runtime.getRuntime().exec("C://Documents and Settings/sureshkumar_ra/Desktop/user.exe");
		waitForElementPresent(this.uiConstants.CLICK, methodName);
		getXpathWebElement(this.uiConstants.CLICK);
		...
		/*
		 * waitForElementPresent(this.uiConstants.GLOBAL, methodName);
		 * getXpathWebElement(this.uiConstants.GLOBAL); element.click();
		 * System.out.println("button clicked"); Thread.sleep(5000);
		 */
		// Secomd(methodName);
